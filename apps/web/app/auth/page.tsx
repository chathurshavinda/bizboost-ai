  ...
  return (
    <AuthLayout>
      <AuthCard
        ...
        subtitle={isLogin ? "Enter your email and password to access your account" : "Enter your email and password to create your account"}
      >
        <div className="authRefModeSwitch" aria-label="Authentication mode">
          <button
            type="button"
            onClick={() => switchTab("login")}
            className={"authRefModeButton" + (isLogin ? " authRefModeButton--active" : "")}
          >
            Sign In
          </button>
          <button
