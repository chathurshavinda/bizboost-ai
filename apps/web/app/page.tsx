    ...
    return (<main className="landingRoot">
      <section className="heroShell">
        <div className="heroPlasmaFrame" aria-hidden>
          <PlasmaHeroBG color="#f4eaff" speed={0.72} direction="forward" scale={1.4} opacity={0.5} mouseInteractive/>
        </div>
      ...
      {!loading && user && (<div className="todayTaskWrap">
          {planFullyCompleted ? (<div className="homePlanCompleteCard">
            ...
            </div>) : (<section className={`homeTaskCard ${isTodayTaskCompleted ? "homeTaskCelebration" : ""}`}>
              ...
              {taskLoading ? (<div className="homeTaskBody">
                ...
                </div>) : taskDay ? (<div className="homeTaskBody">
                  ...
                  {isTodayTaskCompleted ? (<>
                      <div className="homeTaskActionsRow">
                        ...
                        {fallbackDay && fallbackDay.dayNumber !== taskDay.dayNumber ? (<button type="button" className="homeTaskBtn homeTaskBtnPrimary" onClick={() => router.push(`/marketing-plan/day/${fallbackDay.dayNumber}`)}>
                            View Tomorrow →
                          </button>) : null}
                      </div>
          ...
          <section id="how-it-works" className="scrollSection glassPanel">
            ...
            <div className="workflowShell">
              ...
              <StaggerGrid className="workflowTimeline">
                {HOW_STEPS.map((step) => (<StaggerItem key={step.n}>
        ...
        <FadeUp delay={0.06}>
          <section id="features" className="scrollSection glassPanel">
            ...
            <StaggerGrid className="featureGrid">
              {WHAT_YOU_GET.map((f) => (<StaggerItem key={f.title}>
