...
// - GET with missing firebase_uid returns 400.
// - Completed current date returns state=done_today (not next task).
// - Outside range returns next incomplete with state=next_incomplete.
