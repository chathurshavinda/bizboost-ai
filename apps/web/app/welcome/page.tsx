...
export default function WelcomePage() {
  ...
  return (
    <div className="authWrap" style={{ padding: 24 }}>
      <div
        style={{
          width: "100%",
          maxWidth: 760,
          ...
          background:
            "radial-gradient(circle at top left, rgba(34,211,238,0.2), transparent 45%), radial-gradient(circle at bottom right, rgba(34,197,94,0.22), transparent 45%), rgba(15,23,42,0.86)",
