...
export default function BusinessProfileGateModal({ open, onGoToDetails, onBackToHome, }: BusinessProfileGateModalProps) {
    if (!open)
        return null;
    return (<div className="businessProfileModalOverlay" role="presentation">
      <div className="businessProfileModalCard" role="dialog" aria-modal="true" aria-labelledby="business-profile-gate-title" aria-describedby="business-profile-gate-desc">
