...
export default function BusinessProfileErrorModal({
  open,
  onRetry,
  onBackToHome,
}: BusinessProfileErrorModalProps) {
  if (!open) return null;
  ...
  return (
    <div className="businessProfileModalOverlay" role="presentation">
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="business-profile-error-title"
        aria-describedby="business-profile-error-desc"
      >
