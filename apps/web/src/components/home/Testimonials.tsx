...
export default function Testimonials() {
  return (
    <Reveal className="max-w-[1160px] mx-auto mt-10" delayMs={90}>
      <section className="rounded-3xl border border-white/70 bg-white/65 backdrop-blur-2xl shadow-[0_24px_70px_rgba(15,23,42,0.10)] p-6 md:p-8">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          {testimonials.map((item) => (
            <article
              key={item.name}
              className="rounded-2xl border border-white/85 bg-gradient-to-b from-white/95 to-slate-50/85 p-5 shadow-[0_10px_28px_rgba(15,23,42,0.07)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_18px_45px_rgba(124,58,237,0.14)] hover:border-violet-200"
            >
