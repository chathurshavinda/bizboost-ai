...
export default function PricingPreview() {
    return (<Reveal className="max-w-[1160px] mx-auto mt-10" delayMs={120}>
      <section id="pricing" className="rounded-3xl border border-black/15 bg-white/60 backdrop-blur-2xl shadow-[0_24px_70px_rgba(0,0,0,0.10)] p-6 md:p-8">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          {plans.map((plan) => (<article key={plan.name} className={`rounded-2xl border p-5 shadow-[0_10px_28px_rgba(15,23,42,0.07)] transition-all duration-300 hover:-translate-y-1 ${plan.highlight
