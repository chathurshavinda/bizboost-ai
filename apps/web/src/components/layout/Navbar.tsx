    ...
    <nav className={navClassName}>
      <div className="navbarInner">
        <div className="navbarLeft">
          <button
            type="button"
            className={`navMenuTrigger${appMenuOpen ? " navMenuTrigger--open" : ""}`}
        ...
        <div className="navbarRight" ref={mobileRef}>
          ...
          {isAuthed && (
            <div className="navProfileWrap" ref={chipRef}>
              <button
                type="button"
              ...
              {profileOpen && (
                <div className="navProfileMenu" role="menu">
            ...
            <div className="navMobileMenu" role="menu">
              ...
              {!isAuthed && (
                <>
                  ...
                  <Link
                    href="/signup"
                    className="navMobileItem navMobileItem--primary"
                    onClick={() => setMobileOpen(false)}
                  >
                    Get Started
                    <FaArrowRight size={12} aria-hidden />
              ...
              {isAuthed && (
                <>
                  ...
                  <button
                    ...
                    className="navMobileItem navMobileItem--danger"
                  >
                    Logout
                  </button>
                </>
