...
export default function BusinessForm({ registerSectionRef, onModeChange }: BusinessFormProps) {
  ...
  useEffect(() => {
    if (window.sessionStorage.getItem("bizboostProfileDeleted") !== "1") return;
    ...
    const load = async () => {
      ...
      try {
        ...
        if (response.ok && result.ok && result.data) {
          ...
          if (typeof d.country === "string" && d.country.trim()) setCountry(d.country);
          if (typeof d.city === "string") setCity(d.city);
          if (typeof d.language === "string" && d.language.trim()) setLanguage(d.language);
          if (Array.isArray(d.productsOrServices)) setProductsOrServices(d.productsOrServices.join(", "));
          if (typeof d.productsOrServices === "string") setProductsOrServices(d.productsOrServices);
          if (typeof d.targetCustomers === "string") setTargetCustomers(d.targetCustomers);
          if (typeof d.businessGoals === "string") setBusinessGoals(d.businessGoals);
          if (Array.isArray(d.socialLinks)) setSocialLinks(d.socialLinks.join(", "));
          if (typeof d.ownerOrManagerName === "string") setOwnerOrManagerName(d.ownerOrManagerName);
          if (typeof d.teamSize === "string") setTeamSize(d.teamSize);
          if (typeof d.contactEmail === "string") setContactEmail(d.contactEmail);
          if (typeof d.monthlyBusinessBudget === "string") setMonthlyBusinessBudget(d.monthlyBusinessBudget);
          if (typeof d.monthlyMarketingBudget === "string") setMonthlyMarketingBudget(d.monthlyMarketingBudget);
          if (typeof d.expectedRevenueRange === "string") setExpectedRevenueRange(d.expectedRevenueRange);
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    if (!businessType.trim()) nextErrors.businessType = "Business type is required.";
    if (!country.trim()) nextErrors.country = "Country is required.";
    if (!city.trim()) nextErrors.city = "City / location is required.";
    if (!language.trim()) nextErrors.language = "Language is required.";
    if (!productsOrServices.trim()) nextErrors.productsOrServices = "Products or services are required.";
  ...
  return (
    <section className="onboardingMain">
      ...
      <form className="onboardingForm" onSubmit={handleSubmit} noValidate>
        <section
          id="business"
          ref={(el) => registerSectionRef && registerSectionRef("business", el)}
        ...
        >
          <div className="onboardingFieldGroup">
            <label className="onboardingLabel">
              ...
              <input
                type="text"
                className={"onboardingInput" + (errors.businessName ? " onboardingInput--error" : "")}
                placeholder="Eg. Stellar Studio"
                value={businessName}
          ...
          <div className="onboardingFieldGroup">
            <label className="onboardingLabel">
              ...
              <input
                type="text"
                className={"onboardingInput" + (errors.businessType ? " onboardingInput--error" : "")}
                placeholder="Eg. Local restaurant, online store"
                value={businessType}
          ...
          <div className="onboardingFieldRow">
            <label className="onboardingLabel">
              <span>Country</span>
              <select
                className={"onboardingInput onboardingSelect" + (errors.country ? " onboardingInput--error" : "")}
                value={country}
            ...
            <label className="onboardingLabel">
              ...
              <input
                type="text"
                className={"onboardingInput" + (errors.city ? " onboardingInput--error" : "")}
          ...
          <div className="onboardingFieldGroup">
            <label className="onboardingLabel">
              <span>Language</span>
              <select
                className={"onboardingInput onboardingSelect" + (errors.language ? " onboardingInput--error" : "")}
                value={language}
        ...
        <section
          id="products"
          ref={(el) => registerSectionRef && registerSectionRef("products", el)}
        ...
        >
          ...
          <div className="onboardingFieldGroup">
            <label className="onboardingLabel">
              ...
              <textarea
                className={"onboardingInput" + (errors.productsOrServices ? " onboardingInput--error" : "")}
                rows={3}
                placeholder="Eg. Social media management, logo design, Facebook ad campaigns"
          ...
          <div className="onboardingFieldGroup">
            <label className="onboardingLabel">
              ...
              <input
                ...
                placeholder="Eg. Small business owners in Colombo"
          ...
          <div className="onboardingFieldGroup">
            <label className="onboardingLabel">
              ...
              <input
                type="text"
                className="onboardingInput"
                placeholder="Eg. Increase monthly inquiries and conversions"
                value={businessGoals}
          ...
          <div className="onboardingFieldGroup">
            <label className="onboardingLabel">
              ...
              <input
                type="text"
                className="onboardingInput"
                placeholder="Eg. instagram.com/yourbrand, facebook.com/yourbrand"
                value={socialLinks}
          ...
          <div className="onboardingFieldGroup">
            <label className="onboardingLabel">
              ...
              <input
                type="text"
                className="onboardingInput"
                placeholder="Eg. LKR 5,000 - 50,000 per package"
              />
            </label>
          </div>
        </section>
        ...
        <section
          id="team"
          ref={(el) => registerSectionRef && registerSectionRef("team", el)}
          style={{ display: "flex", flexDirection: "column", gap: 16, paddingTop: 18 }}
        >
          ...
          <div className="onboardingFieldGroup">
            <label className="onboardingLabel">
              ...
              <input
                type="text"
                className="onboardingInput"
                placeholder="Eg. Jane Perera"
                value={ownerOrManagerName}
                onChange={(e) => setOwnerOrManagerName(e.target.value)}
              />
            </label>
          </div>
          ...
          <div className="onboardingFieldGroup">
            <label className="onboardingLabel">
              ...
              <input
                type="text"
                className="onboardingInput"
                placeholder="Eg. Solo founder, 3 full-time, 2 part-time"
                value={teamSize}
          ...
          <div className="onboardingFieldGroup">
            <label className="onboardingLabel">
              ...
              <input
                type="email"
                className="onboardingInput"
                placeholder="Eg. hello@yourbusiness.lk"
                value={contactEmail}
        ...
        <section
          id="financials"
          ref={(el) => registerSectionRef && registerSectionRef("financials", el)}
          style={{ display: "flex", flexDirection: "column", gap: 16, paddingTop: 18 }}
        >
          ...
          <div className="onboardingFieldGroup">
            <label className="onboardingLabel">
              ...
              <input
                type="text"
                className="onboardingInput"
                placeholder="Eg. LKR 100,000 per month"
                value={monthlyBusinessBudget}
                onChange={(e) => setMonthlyBusinessBudget(e.target.value)}
              />
            </label>
          </div>
          ...
          <div className="onboardingFieldGroup">
            <label className="onboardingLabel">
              ...
              <input
                type="text"
                className="onboardingInput"
                placeholder="Eg. LKR 25,000 per month"
          ...
          <div className="onboardingFieldGroup">
            <label className="onboardingLabel">
              ...
              <input
                type="text"
                className="onboardingInput"
                placeholder="Eg. LKR 200,000 - 500,000 per month"
                value={expectedRevenueRange}
                onChange={(e) => setExpectedRevenueRange(e.target.value)}
              />
            </label>
          </div>
