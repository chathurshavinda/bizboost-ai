export default function AuthHeroIllustration({ className, }: {
    ...
    return (<svg className={className} viewBox="0 0 400 520" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" role="img" aria-hidden={true}>
      <defs>
        <linearGradient id="authHero-bg" x1="40" y1="0" x2="360" y2="520" gradientUnits="userSpaceOnUse">
          <stop stopColor="#f8fafc"/>
          <stop offset="0.45" stopColor="#f1f5f9"/>
          <stop offset="1" stopColor="#e2e8f0"/>
        </linearGradient>
        <linearGradient id="authHero-desk" x1="200" y1="380" x2="200" y2="520" gradientUnits="userSpaceOnUse">
          <stop stopColor="#cbd5e1" stopOpacity="0.35"/>
          <stop offset="1" stopColor="#94a3b8" stopOpacity="0.5"/>
        </linearGradient>
        <linearGradient id="authHero-screen" x1="168" y1="312" x2="232" y2="368" gradientUnits="userSpaceOnUse">
          <stop stopColor="#ecfdf5"/>
          <stop offset="1" stopColor="#d1fae5"/>
        </linearGradient>
        <filter id="authHero-float" x="-20%" y="-20%" width="140%" height="140%" filterUnits="objectBoundingBox">
      ...
      <g filter="url(#authHero-float)">
        <rect x="24" y="44" width="112" height="86" rx="12" fill="#ffffff" stroke="#e2e8f0" strokeWidth="1"/>
      ...
      <g filter="url(#authHero-float)">
        <rect x="268" y="56" width="108" height="92" rx="12" fill="#ffffff" stroke="#e2e8f0" strokeWidth="1"/>
        ...
        <path d="M286 88 L318 76 L350 82" stroke="#0f172a" strokeOpacity="0.2" strokeWidth="1.5" strokeLinecap="round"/>
        <circle cx="318" cy="76" r="3" fill="#22c55e"/>
      </g>

      
      <g filter="url(#authHero-float)">
        <rect x="248" y="188" width="124" height="96" rx="14" fill="#ffffff" stroke="#e2e8f0" strokeWidth="1"/>
      ...
      <g filter="url(#authHero-float)">
        <rect x="28" y="168" width="118" height="72" rx="12" fill="#ffffff" stroke="#e2e8f0" strokeWidth="1"/>
        <path d="M44 190 L52 198 L44 206 M48 194 L48 202" stroke="#22c55e" strokeWidth="2" strokeLinecap="round"/>
      ...
      <g filter="url(#authHero-float)">
        <rect x="272" y="312" width="104" height="78" rx="12" fill="#ffffff" stroke="#e2e8f0" strokeWidth="1"/>
        ...
        <path d="M292 348 L302 338 L312 348 L322 334 L332 340" stroke="#22c55e" strokeWidth="2.2" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M284 378 Q300 368 316 372 T348 364" stroke="#22c55e" strokeWidth="2" fill="none" strokeLinecap="round"/>
      </g>

      
      <path d="M0 420 C80 400 120 412 200 408 C280 404 320 392 400 408 L400 520 L0 520 Z" fill="url(#authHero-desk)"/>

      
      <ellipse cx="208" cy="268" rx="36" ry="44" fill="#1e293b" opacity="0.92"/>
      <path d="M176 288 Q168 340 172 388 L188 388 Q192 340 200 308 Q216 320 232 308 Q240 340 244 388 L260 388 Q268 340 252 288 Q232 272 208 268 Q184 272 176 288Z" fill="#334155"/>
      <path d="M168 318 Q156 332 148 352 L162 358 Q172 338 180 328Z" fill="#475569"/>
      <path d="M248 318 Q264 332 276 352 L262 358 Q250 338 240 328Z" fill="#475569"/>
      ...
      <path d="M170 378 L182 368 L194 374 L206 360 L218 352 L230 358" stroke="#059669" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
      ...
      <path d="M124 210 Q150 240 168 338" stroke="#22c55e" strokeOpacity="0.15" strokeWidth="1" strokeDasharray="3 4" fill="none"/>
    </svg>);
}
